 ...
 public interface SysRoleMapper extends BaseMapperX<SysRole>
{
     ...
     * @return 角色信息
     */
     SysRole checkRoleNameUnique(@Param("roleName") String roleName, @Param("tenantId") Long tenantId);
     ...
     * @return 角色信息
     */
     SysRole checkRoleKeyUnique(@Param("roleKey") String roleKey, @Param("tenantId") Long tenantId);
